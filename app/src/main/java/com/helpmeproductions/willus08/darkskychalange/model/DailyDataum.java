...
public class DailyDataum {
    ...
    public DailyDataum(String icon, Float temperatureHigh, Float temperatureLow, Float apparentTemperatureHigh, Float apparentTemperatureLow, Float dewPoint, Float humidity, Float windSpeed) {
        this.icon = icon;
